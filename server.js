...
app.post("/checkout", (req, res) => {
  ...
  const continue_success_url = "http://localhost:3000/";

  const dataToHash = `${req_time}${merchant_id}${tran_id}${amount}${items}${shipping}${firstName}${lastName}${email}${phone}${type}${continue_success_url}${currency}${return_params}`;
